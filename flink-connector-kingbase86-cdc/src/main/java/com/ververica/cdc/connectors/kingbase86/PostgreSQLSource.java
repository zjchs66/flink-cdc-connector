...
package com.ververica.cdc.connectors.kingbase86;

import com.ververica.cdc.debezium.DebeziumDeserializationSchema;
import com.ververica.cdc.debezium.DebeziumSourceFunction;
import com.ververica.cdc.debezium.Validator;
import io.debezium.connector.kingbase86.PostgresConnector;
...
public class PostgreSQLSource {
    ...
    public static class Builder<T> {
        ...
        private int port = 54321; // default 5432 port
...
//            props.setProperty("date.handling.mode","string");
            props.setProperty("time.precision.mode","connect");
//            props.setProperty("snapshot.mode","never");
            props.setProperty("heartbeat.wal.update.interval.ms","600000");
//            props.setProperty("signal.data.collection","PUBLIC.debezium_signal1");
            //props.setProperty("table.exclude.list","public.")
            ...
            if (tableList != null) {
                props.setProperty("table.whitelist", String.join(",", tableList) + ",PUBLIC.wal_heartbeat");
            }
