...
//                    ((MySqlSourceFetchTaskContext) context).getDispatcher());
    ...
    public static class MySqlSnapshotSplitReadTask extends AbstractSnapshotChangeEventSource {
        ...
        public SnapshotResult execute(ChangeEventSourceContext context)
                throws InterruptedException {
            SnapshottingTask snapshottingTask = getSnapshottingTask(offsetContext);
        ...
        protected SnapshotResult doExecute(
            ...
            dispatcher.dispatchWatermarkEvent(
                    null, snapshotSplit, lowWatermark, WatermarkKind.LOW);
            ...
            dispatcher.dispatchWatermarkEvent(
                    null, snapshotSplit, highWatermark, WatermarkKind.HIGH);
            return SnapshotResult.completed(ctx.offset);
        }

        @Override
        protected SnapshotResult doExecute(ChangeEventSourceContext context, OffsetContext previousOffset, SnapshotContext snapshotContext, SnapshottingTask snapshottingTask) throws Exception {
            return null;
        }
        ...
        protected ChangeRecordEmitter getChangeRecordEmitter(
            ...
            return new SnapshotChangeRecordEmitter(null,snapshotContext.offset, row, clock);
        }
